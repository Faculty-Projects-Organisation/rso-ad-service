...
public class GenericRepository<T> : IGenericRepository<T> where T : class
{
    ...
    /// </summary>
    /// <param name="context">The <see cref="AdServicesRSOContext"/> context from the database access.</param>
    ...
    /// <inheritdoc/>
    public async Task<List<T>> GetManyAsync(Expression<Func<T, bool>> filter = null, Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null, int? top = null, int? skip = null, params string[] includeProperties)
    {
